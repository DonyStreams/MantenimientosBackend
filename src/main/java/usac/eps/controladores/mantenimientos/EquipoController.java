...
public class EquipoController {
    ...
    public Response update(@PathParam("id") Integer id, EquipoModel equipo) {
        try {
            ...
            boolean cambioImagen = (equipoAnterior.getFotografia() != null && !equipoAnterior.getFotografia().equals(equipo.getFotografia()));
            boolean cambioUbicacion = (equipoAnterior.getUbicacion() != null && !equipoAnterior.getUbicacion().equals(equipo.getUbicacion()));
    ...
    public Response delete(@PathParam("id") Integer id) {
        ...
        try {
            ...
            if (countProgramaciones > 0 || countEjecuciones > 0 || countHistorial > 0 || countTickets > 0) {
                StringBuilder mensaje = new StringBuilder("No se puede eliminar el equipo porque tiene registros relacionados: ");
                ...
                if (countEjecuciones > 0) {
                    if (hayRelaciones) mensaje.append(", ");
